...
const PluginEndpointForm = ({
 ...
 return (
   <Box display="flex" flexDirection="column" gap={2}>
     ...
     <Typography variant="body1">Authentication (Optional)</Typography>
     ...
     <Grid container spacing={2} mb="15px">
       <Grid size={6}>
         <Tooltip
           title={
             <Typography>
               Authentication type for your API endpoint. Select "None" if your
         ...
         >
           <FormControl fullWidth>
             ...
             >
               ...
               <MenuItem value={"apiKey"}>API Key (X-API-Key header)</MenuItem>
               <MenuItem value={"bearer"}>Bearer Token (Authorization header)</MenuItem>
             </Select>
           </FormControl>
         </Tooltip>
       </Grid>
         ...
         <Grid size={6}>
           <Tooltip
             title={
               <Typography>
                 {authType === "apiKey"
                   ? "API Key to be sent in X-API-Key header"
           ...
           >
             <TextField
               fullWidth
               label={authType === "apiKey" ? "API Key" : "Bearer Token"}
               type="password"
               required
               helperText="Your secret key or token"
               value={apiKey}
