   ...
   <Box width="100%" height="50vh" pl={3} sx={{ overflowY: "auto" }} py={1}>
     ...
     {selectedSection === "endpoints" && (
       <Box>
         ...
         <Typography variant="body1" mt="15px" mb="15px">
         ...
         <Grid container spacing={2} mb="15px">
           <Grid size={6}>
             <Tooltip
               title={
                 <Typography>
                   Authentication type for your API endpoint. Select "None" if
             ...
             >
               <FormControl fullWidth>
                 ...
                 <Select
                   ...
                   labelId="authType"
                   id="authType"
                   value={editedPlugin.authType || "none"}
           ...
           {editedPlugin.authType && editedPlugin.authType !== "none" && (
             <Grid size={6}>
               <Tooltip
                 title={
                   <Typography>
